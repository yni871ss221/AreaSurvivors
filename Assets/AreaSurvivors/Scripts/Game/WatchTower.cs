...
namespace AreaSurvivors
{
    ...
    public sealed class WatchTower : MonoBehaviour, IBuildableConstruction
    {
        ...
        public Vector3 spriteVisualOffset = new Vector3(0f, -1f, 0f);
        ...
        void ConfigureSpriteVisual(PaperMeshVisual visual, Color color)
        {
            ...
            var bounds = towerSprite.bounds.size;
        ...
        void AnimateHammer()
        {
            ...
            hammerRenderer.transform.localPosition = spriteVisualOffset + new Vector3(0.18f, spriteVisualSize.y * 0.5f + 0.42f + Mathf.Abs(swing) * 0.08f, 0f);
            ApplyToolVisualScale(hammerRenderer.transform);
        }
