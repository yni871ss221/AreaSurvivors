...
namespace AreaSurvivors.Editor
{
    public static class WorkerHutSetup
    {
        ...
        [MenuItem("Area Survivors/Setup Worker Hut")]
        public static void Run()
        {
            ...
            Debug.Log("Worker hut setup completed.");
        }
        ...
        {
            var go = new GameObject("WorkerHut");
            var marker = go.AddComponent<GridObjectMarker>();
            marker.type = GridObjectType.WorkerHut;
            ...
            var hut = go.AddComponent<WorkerHut>();
        ...
        static void UpdateConfig()
        {
            ...
            config.workerHutAutoGatherBaseIntervalSeconds = 5f;
            config.workerHutAutoGatherIntervalReductionPerLevel = 1f;
            config.workerHutAutoGatherBaseAmount = 1;
            config.workerHutAutoGatherAmountPerLevel = 1;
        ...
        static void UpdateGameScene(Sprite sprite, Tile tile, GameObject prefab)
        {
            ...
            if (placement != null)
            {
                placement.workerHutPrefab = prefab;
                placement.workerHutPreviewSprite = sprite;
                placement.workerHutTile = tile;
        ...
        static void UpdateConstructionMenu(Transform menu, Sprite sprite)
        {
            ...
            var existing = menu.Find("Build Slot 6");
            if (existing == null)
            {
                var source = menu.Find("Build Slot 5");
                if (source == null) source = menu.Find("Build Slot 4");
                if (source == null) source = menu.Find("Build Slot 3");
                if (source == null) return;
                existing = Object.Instantiate(source.gameObject, menu).transform;
                existing.name = "Build Slot 6";
            }
            ...
            if (slotRect != null)
            {
                ...
                slotRect.anchoredPosition = slotPositions[5];
            }
            SetText(existing, "Key", "6");
